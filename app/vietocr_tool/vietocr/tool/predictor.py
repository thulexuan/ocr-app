from vietocr_tool.vietocr.tool.translate import build_model, translate, translate_beam_search, process_input, predict
...
class Predictor():
    def __init__(self, config):
        ...
        #     print('print weights path here:')
        #     print(weights)
        # else:
        #     weights = config['weights']

        current_dir = os.path.dirname(os.path.abspath(__file__))
        model_path = os.path.join(current_dir, 'vgg_transformer.pth')
